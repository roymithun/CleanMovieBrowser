...
CleanMovieBrowser is a sample project that showcases how to download movies information from a public repo [TMDB](https://www.themoviedb.org/).

The goal of the project is to combine popular libraries/tools and demonstrate best development practices by utilizing up to date tech-stack and presenting modern Android application [Architecture](#architecture) that is modular, scalable, maintainable, and testable.
This application could be useful for providing a base for larger scalable real world projects.

## Project characteristics and tech-stack

<img src="misc/image/app_list.png" width="336" align="top" hspace="20">
...
Clean architecture has been followed. Feature related code is placed inside one of the feature modules.
...
![module_dependencies](misc/image/module_dependencies.png)
...
![module_dependencies_layers](misc/image/module_dependencies_layers.png?raw=true)
...
![feature_structure](misc/image/feature_structure.png?raw=true)
